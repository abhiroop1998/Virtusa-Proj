...
public class HomeController {
	...
	@RequestMapping("/clothshelf")
	public String clothshelf(Model model,Principal principal) {
	...
	public String clothDetail(@PathParam("id") Long id, Model model, Principal principal) {
		if (principal != null) {
			String username = principal.getName();
			User user = userService.findByUsername(username);
			model.addAttribute("user", user);
